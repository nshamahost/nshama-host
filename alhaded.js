$(`<div class="rainbow"><img src="" class="fl" style="width:100%;margin-top: 1px;background-color: white;border-radius: 10px;"></div>
...
$(".fa-gear").text("الاعدادات ").css("width","")
  ...
  $("marquee").text(" أهلا وسهلا بكم في :شـات ادمان » تستطيع الدخول من جوالك او اللاب توب او الاي باد ومن جميع الاجهزة اللوحيه نتمنى لكم قضاء اجمل الاوقات معنـــا - الادارة");
...
<p class="bg-primary"> ??? <p class="bg-primary">｢للشكاوي والاقتراحات ｣｢</p><p class="bg-primary"> ??? </p> ??? </div> 
    ...
    <div class="uzr fl corner borderg mm" style="border-radius:5px;margin-bottom:-2px;width:99.5%;padding:0px; background-color:white;">
      ...
      <div class="uzr fl" style="padding:0px;width:80%">
        <div style="padding:0px;width:100%;" class="fl">
          ...
          <span style="padding: 1px 8px; margin-top: 2px; display: block; max-width: 82%; border-radius: 3px; color: E00000(199, 103, 48);" class="corner nosel u-topic dots fl hand">شات ادمان الرسمي</span>
        </div>
        <br>
        <div style="padding: 0px; width: 100%; color: rgb(60, 0, 255);" class=" u-msg   break  fl">
        <div style="padding: 0px;width: 100%;color: rgb(60, 0, 255);text-align: left;display: block;margin-top: -17px;" class=" u-msg   break  fl"> مرحباً بك 👋👋👋👋 <h1 style="display: inline-block;color: red;">`+ getuser(myid).topic+ `</h1> نقدّر تواجدك معنا في شات ادمان  ونتمنى لك يوماً سعيداً إن شاء الله </div>
      </div>
    </div></div>
`).appendTo('div#d2')
clearInterval(myVar);
